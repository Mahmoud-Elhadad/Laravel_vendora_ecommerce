...
<div class="modal fade" id="deleteAdminModal-{{ $admin->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteAdminModalLabel-{{ $admin->id }}" aria-hidden="true">
