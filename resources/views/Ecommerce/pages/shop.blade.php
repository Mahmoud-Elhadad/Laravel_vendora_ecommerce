...
<section class="page-title-bar">
    <div class="container">
        <h1 id="page-title-text">Shop</h1>
        <p class="mb-0 mt-2 text-white-50">Explore the full catalog with powerful filters and sorting.</p>
    ...
    <div class="container section-sm">
        <div class="row g-4">
            ...
            <aside class="col-lg-3">
                ...
                <div id="shop-filters">
                    <form method="GET" action="{{ route('ecomm.shop.page') }}" id="filter-form">
                        ...
                        <button type="button"
                                ...
                                onclick="window.location='{{ route('ecomm.shop.page') }}'">
            ...
            <div class="col-lg-9">
                ...
                <div class="shop-toolbar mb-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <form method="GET" action="{{ route('ecomm.shop.page') }}" id="sort-form" class="d-flex align-items-center gap-2">
                ...
                @if (request('cat') || request('search'))
                    <div class="mb-3 d-flex flex-wrap gap-2" id="active-filters">
                        @if (request('cat'))
                            ...
                            @if ($activeCat)
                                <a href="{{ route('ecomm.shop.page', array_merge(request()->except('cat'), ['sort' => $sort])) }}"
                        ...
                        @endif
                        @if (request('search'))
                            <a href="{{ route('ecomm.shop.page', array_merge(request()->except('search'), ['sort' => $sort])) }}"
                               class="badge bg-primary-v text-decoration-none">
                ...
                @if ($products->isEmpty())
                    <div class="text-center py-5">
                        ...
                        <a href="{{ route('ecomm.shop.page') }}" class="btn btn-outline-v">Clear filters</a>
                    </div>
                @else
